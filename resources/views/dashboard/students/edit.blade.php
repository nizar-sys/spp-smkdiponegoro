                            ...
                            <div class="col-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('nisn') is-invalid @enderror" id="nisn"
                                        placeholder="NISN Siswa" value="{{ old('nisn', $student->nisn) }}" name="nisn">
                            ...
                            <div class="col-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('nis') is-invalid @enderror"
                                        id="nis" placeholder="NIS Siswa" value="{{ old('nis', $student->nis) }}"
                                        name="nis">
                            ...
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                                        placeholder="Nama Siswa" value="{{ old('nama', $student->nama) }}" name="nama">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group mb-3">
                                    ...
                                    placeholder="Alamat Siswa" name="alamat" cols="30" rows="4">{{old('alamat', $student->alamat)}}</textarea>
                            ...
                            <div class="col-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('no_hp') is-invalid @enderror"
                                        ...
                                        name="no_hp" value="{{old('no_hp', $student->no_hp)}}">
