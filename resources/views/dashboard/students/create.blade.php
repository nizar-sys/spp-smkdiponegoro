        ...
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Formulir Tambah Data Kelas</h3>
                </div>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('nis') is-invalid @enderror"
                                        id="nis" placeholder="NIS Siswa" value="{{ old('nis') }}" name="nis">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                        id="nama" placeholder="Nama Siswa" value="{{ old('nama') }}" name="nama">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat" placeholder="Alamat Siswa"
                                        name="alamat" cols="30" rows="4">{{ old('alamat') }}</textarea>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control @error('jenis_kelamin') is-invalid @enderror" id="jenis_kelamin"
                                        ...
                                        @foreach (['Laki-laki', 'Perempuan'] as $jk)
                                            <option value="{{ $jk }}" @if (old('jenis_kelamin') == $jk) selected @endif>
                                                {{ $jk }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('tempat_tanggal_lahir') is-invalid @enderror"
                                        id="tempat_tanggal_lahir" placeholder="Tempat, Tanggal Lahir Siswa" value="{{ old('tempat_tanggal_lahir') }}" name="tempat_tanggal_lahir">
